...
object WeTypeSettings {
    ...
    const val DEFAULT_LIGHT_COLOR = 0x46D1D3D8.toInt()
    const val DEFAULT_DARK_COLOR = 0x40000000
    const val DEFAULT_BLUR_RADIUS = 50
    const val DEFAULT_CORNER_RADIUS = 30
    ...
    const val DEFAULT_EDGE_HIGHLIGHT_INTENSITY = 10
    ...
    const val DEFAULT_CANDIDATE_BACKGROUND_LEFT_MARGIN_DP = 7
    const val DEFAULT_CANDIDATE_PINYIN_LEFT_MARGIN_DP = 15
    const val DEFAULT_TOOLBAR_ICON_BG_OPACITY = 0
